        ...
        <Screen style={styles.container}>
            ...
            <ScrollView contentContainerStyle={styles.scrollView}>
                <View style={styles.centeredView}>
                    ...
                    <TouchableOpacity style={styles.section} onPress={() =>  navigation.navigate("AccountSettings", {navigation})}>
                    ...
                    <TouchableOpacity style={styles.section} onPress={() =>  navigation.navigate("AccountConnections", {navigation})}>
                        <MaterialCommunityIcons name="card-account-details-star" size={24} color="white" style={styles.icon} />
                        <AppText style={styles.sectionText}>Conexiones</AppText>
                    </TouchableOpacity>
